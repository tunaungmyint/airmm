...
const HeaderSection = ({ placeholder }) => {
  ...
  return (
    <div className="sticky bg-white top-0 z-50 grid grid-cols-3 shadow-md p-5 md:px-10">
      ...
      <div
        onClick={() => router.push('/')}
        className="relative flex justify-between items-center h-10 cursor-pointer my-auto"
      >
        <Image
        ...
        <div className="flex flex-col col-span-3 mx-auto">
          ...
          <div className="flex items-center border-b mb-4">
            ...
            <input
              ...
              min={1}
              type="number"
              className="w-12 text-lg outline-none ml-2"
            />
          </div>
          <div className="flex">
